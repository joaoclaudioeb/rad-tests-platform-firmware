# DAC/ADC SPI
set_property -dict {PACKAGE_PIN AB11 IOSTANDARD LVCMOS33} [get_ports spi0_io1_i]; # JA7
set_property -dict {PACKAGE_PIN AB10 IOSTANDARD LVCMOS33} [get_ports spi0_io0_o]; # JA8
set_property -dict {PACKAGE_PIN AB9 IOSTANDARD LVCMOS33} [get_ports spi0_sck_o]; # JA9
set_property -dict {PACKAGE_PIN AA8 IOSTANDARD LVCMOS33 PULLUP TRUE} [get_ports spi0_ss1_o]; # JA10
